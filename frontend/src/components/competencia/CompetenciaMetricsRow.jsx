...
/**
 * KPIs configurables para Competencia. Mismo patrón que ClientesMetricsRow:
 * picker de hasta N métricas, persistencia en localStorage, tooltip ⓘ.
 *
 * Props:
 *   title, subtitle, data, availableMetrics, defaultSelected, maxSelected,
 *   storageKey, onOpenGlossary
 */
export default function CompetenciaMetricsRow({
  title = 'Indicadores',
  subtitle,
  data,
  availableMetrics,
